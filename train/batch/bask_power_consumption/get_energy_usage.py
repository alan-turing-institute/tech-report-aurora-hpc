...
TDP_A100_80 = 400  # Watts

all_out_files = sorted(glob("./*/*_*_*_*.txt"))
...
energy_df.to_csv("bask_energy_consumption_summary.csv", index=False)
print("Energy consumption summary saved to bask_energy_consumption_summary.csv")
