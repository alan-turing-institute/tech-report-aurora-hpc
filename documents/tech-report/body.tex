...
\caption{\label{fig:pvg-Dawn}Comparison of prediction {\it vs.} ground
  truth after 7 day rollout for the two-meter temperature in the range
   (\qty{223.15}{\kelvin}, \qty{323.15}{\kelvin}), generated on Dawn.}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=1.0\linewidth]{plot-pvg-bask.pdf}
\caption{\label{fig:pvg-bask}Comparison of prediction {\it vs.} ground
  truth after 7 day rollout for the two-meter temperature in the range
   (\qty{223.15}{\kelvin}, \qty{323.15}{\kelvin}), generated on Baskerville.}
\end{figure}
...
For comparison, running the same inference steps on Baskerville gave
an average step time of 6.09 seconds. The total time for all 28 steps
was 180.54 seconds. The total run time, including data and model
loading, was 255.48 seconds. Given the small variation between runs,
these results are broadly in line with those from Dawn, suggesting
similar overall performance. Table \ref{tab:inference} summarises these results.
